 ...
 * respectively.
 */
interface PaperDropdownMenuElement extends Polymer.IronButtonState, Polymer.IronControlState, Polymer.IronFormElementBehavior, Polymer.IronValidatableBehavior, Polymer.LegacyElementMixin, HTMLElement {
  keyBindings: object;
